...
const  EpisodePageId=() =>{ 
    ...
    useEffect(()=>{
      fetch(process.env.NEXT_PUBLIC_DOMAIN+`/episode/${params.id}`) 
    ...
    <>
        <Head>
          <title>Eposodes</title>
        </Head>            
        <Layout>
            <div className={styles.conteiner} >
              <Link className={styles.back} href={{pathname:`/episodes`,query:{        
            ...
            {results!==undefined&&<CardResident results={results}/>}
        </Layout>
    </>);  
  };
  
  export default  EpisodePageId;